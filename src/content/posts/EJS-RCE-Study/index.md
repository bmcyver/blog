...
```javascript title="lib/ejs.js (v3.1.10)" {35-38}
...
```javascript title="lib/ejs.js (v3.1.10)" {2-3}
...
```javascript title="lib/ejs.js (v3.1.10)"
try {
  if (opts.async) {
...
```javascript title="lib/ejs.js (diff v3.1.6 <-> v3.1.7)" ins={2-4,7-9,14-17}
...
```javascript title="lib/ejs.js (v3.1.7)" "escapeFn.toString()"
if (opts.client) {
...
```javascript title="lib/ejs.js (diff v3.1.7 <-> v3.1.10)" ins={3-4} del={1-2}
