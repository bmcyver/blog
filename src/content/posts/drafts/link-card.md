  ...
  <a href="https://astro.build/" class="link-card">
    <div class="link-card__info">
      ...
      <div class="link-card__description">
        Astro builds fast content sites, powerful web applications, dynamic
        server APIs, and everything in-between.
      </div>
      <div class="link-card__metadata">
        <div class="link-card__domain">
          <img
            ...
            src="https://www.google.com/s2/favicons?domain=astro.build"
          />
    ...
    <div class="link-card__thumbnail">
      <img
        alt="Astro - Build the web you want."
        class="link-card__image"
        src="https://astro.build/og/astro.jpg"
      />
    </div>
  </a>
</div>
