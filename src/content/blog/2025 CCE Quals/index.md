...
웹 6문제 중에서 3문제를 풀었다. 이번 글에서는 업솔빙한 문제를 포함해서 총 3문제를 작성했다.

## Web/First Day (27 Solves, 250 Points)

꽤 재미있었던 문제다. 단순한 `XSS`지만 컨테이너의 아웃바운드 네트워크가 **UDP만 허용**되는 제약이있다. 때문에 두 가지 방법을 생각할 수 있다. <br/>
